    ...
    public NettyServerTransport(
        ...
        this.pipelineFactory = new ChannelPipelineFactory() {
            ...
            public ChannelPipeline getPipeline()
                ...
                /*通过NiftyIODispatcher实现io和业务线程分离*/
                ...
                /**
                 * 处理业。
                 * 因为上面的NiftyIODispatcher新开了线程处理并交给pipeline处理，因此到达此处handler的已经不是原来请求的线程了
                 * req
                 * ||
                 * NiftyIODispatcher
                 * ||       ||
                 * resp     NiftyDispatcher
                 * 也是io和业务分离的缘故，到时NiftyDispatcher的逻辑异常复杂，难以看懂，关键要明晰ordered request 和 out-of-order response
                 *
                 * */
